		...
		<tr>
			<td  width="600px">
				<fieldset>
					...
					<hr>
					Password<br/><input type="password" name ="password" id="password" onkeyup="PasswordValidation()"><?php echo $passError;?><br/><br/>
                    <hr>																				 
					...
					<hr/>
					phone<br/><input type="text" name="phone" id="phone" onkeyup="NumberValidation()"><?php echo $noError;?><br/><hr/><br/>
